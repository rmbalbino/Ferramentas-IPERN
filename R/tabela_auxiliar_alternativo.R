...
tryCatch(
  ...
  expr = {
    ...
    error = function(e){ report_failure("Erro!", "Verifique se você selecionou a pasta correta. Além disso, o nome dos arquivos precisa conter 'FL. PGTO' e as colunas das planilhas devem estar devidamente nomeadas.")} ) # Fim do erro
